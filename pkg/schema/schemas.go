...
func accepts[F field.Element[F], C Constraint[F]](parallel bool, iter iter.Iterator[C],
	trace rtrace.Trace[F], schema Schema[F, C]) []Failure {
	//
	if parallel {
...
func sequentialAccepts[F field.Element[F], C Constraint[F]](iter iter.Iterator[C], trace rtrace.Trace[F],
...
func parallelAccepts[F field.Element[F], C Constraint[F]](iter iter.Iterator[C], trace rtrace.Trace[F],
...
func processConstraint[F field.Element[F], C Constraint[F]](ith C, trace rtrace.Trace[F], schema Schema[F, C],
