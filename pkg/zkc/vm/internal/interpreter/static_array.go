...
// Accesses implementation for Memory interface.  A static array (ROM / WOM /
// static ROM) does not record accesses; read-write memories override this.
func (p *StaticArray[W, C]) Accesses() []AccessData[W] {
	return nil
}
