...
// Accesses implementation for Memory interface: the chronological access log
// (empty unless a recording log is installed for trace generation).
func (p *PagedRandomAccess[W]) Accesses() []AccessData[W] {
